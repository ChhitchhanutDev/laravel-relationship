<a href="" data-bs-toggle="modal" data-bs-target="#deleteCategory{{$category->id}}">Delete</a>
    ...
    <form action="{{ route('category.delete', $category->id) }}" method="POST">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Delete: {{ $category->name }}</h1>
            </div>
